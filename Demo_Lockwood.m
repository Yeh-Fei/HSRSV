...
fprintf('============================================================= HSRSV ============================================================= \n');
par.K=20;        par.iter=150;     par.lamS=1e-3;   par.lamM=1e0;  
par.lamT=1e-2;   par.lamZ=1e-3;    par.eta=1e-1;    par.lam=1e-1;  
par.gam=5;       par.Scale=0.95;   p={1/2,2/3};     SparseX={'1','mcp'};
...
BGS_GTF.addatoms=[0,0];  BGS_GTF.turank=[80,100,50]; BGS_GTF.shape_re=[4,20,4,25,5,10];
BGS_GTF.MaxLoop=500;     BGS_GTF.IniLoop=100;        BGS_GTF.ConvTol=1e-3;
BGS_GTF.rho=1e-3;        BGS_GTF.mu=1e0;      
Time.BGS=tic;
...
FuVar.lambda_m=1e-1;  FuVar.lambda_a=1e-3;  FuVar.lambda_1=1e-1; 
...
%%  GSFus 
fprintf('============================================================= GSFus ============================================================= \n');
GSFus.subspace=6;      GSFus.lambda_1=1e-4; 
GSFus.lambda_2=1e-4;   GSFus.mu=1e1;       
Time.GSFus=tic;
...
%%  BTD-Var
fprintf('============================================================= BTD-Var ============================================================= \n');
BTD_Var.R=4;        BTD_Var.L=14;       BTD_Var.nIter=1e2;  
