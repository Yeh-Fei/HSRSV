...
fprintf('============================================================= HSRSV ============================================================= \n');
par.K=5;         par.iter=80;     par.lamS=1e-4;   par.lamM=1e0;  
par.lamT=1e3;    par.lamZ=1e-3;   par.eta=1e-3;    par.lam=1;     
par.gam=10;      p={1/2,2/3};     SparseX={'1','mcp'};
...
BGS_GTF.Pr{1,3}=R;       BGS_GTF.nu=1.3;              BGS_GTF.lambda=1e1;    
BGS_GTF.addatoms=[0,0];  BGS_GTF.turank=[480,320,12]; BGS_GTF.shape_re=[15,32,10,32,3,4];
BGS_GTF.MaxLoop=500;     BGS_GTF.IniLoop=1000;        BGS_GTF.ConvTol=1e-7;
BGS_GTF.rho=1e-3;        BGS_GTF.mu=1e0;        
Time.BGS=tic;
    BGS_GTF.HSR=ReTF(H,M,BGS_GTF.Pr,BGS_GTF.lambda,BGS_GTF.mu,BGS_GTF.rho,BGS_GTF.nu,BGS_GTF.turank,BGS_GTF.addatoms,BGS_GTF.shape_re,BGS_GTF.IniLoop,BGS_GTF.MaxLoop,BGS_GTF.ConvTol);
...
FuVar.lambda_m=1;    FuVar.lambda_a=1e-6;  FuVar.lambda_1=1e-2;  
FuVar.lambda_2=1e4;  Psi_init=ones(L,p);
Time.FuVar=tic;
...
%%  BTD-Var
fprintf('============================================================= BTD-Var ============================================================= \n');
BTD_Var.R=6;        BTD_Var.L=9;         BTD_Var.nIter=80;  
BTD_Var.lamda=1e1;  BTD_Var.r=BTD_Var.L*ones(1,BTD_Var.R);
Time.BTD_Var=tic;
