function [Z,ob] = ReTF_mod(X,Y,P,lambda,mu,rho,nu,turank,addatoms,shape_re,IniLoop,MaxLoop,ConvTol)
%RETF 此处显示有关此函数的摘要
%   此处显示详细说明
...
G=G_Coding_mod(X,Y,P,zeros(corerank),U,lambda,rho,nu,corerank,shape_re,MaxLoop,ConvTol);
% % % % % % % % % % % % % % % % % % % % % % % % % % G=rand(turank);
