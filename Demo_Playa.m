...
fprintf('============================================================= HSRSV ============================================================= \n');
par.K=14;        par.iter=135;     par.lamS=1e-3;   par.lamM=1e0;  
par.lamT=1e-2;   par.lamZ=1e-3;    par.eta=1e-1;    par.lam=1e-1;  
par.gam=2;       par.Scale=0.98;   p={1/2,2/3};     SparseX={'1','mcp'};
...
BGS_GTF.Pr{1,3}=R;       BGS_GTF.nu=1.3;             BGS_GTF.lambda=1e0;       
BGS_GTF.addatoms=[0,0];  BGS_GTF.turank=[80,128,50]; BGS_GTF.shape_re=[4,20,4,32,5,10];
BGS_GTF.MaxLoop=500;     BGS_GTF.IniLoop=100;        BGS_GTF.ConvTol=1e-3;
BGS_GTF.rho=1e-5;        BGS_GTF.mu=1e0;    
Time.BGS=tic;
    BGS_GTF.HSR=ReTF_playa(H,M,BGS_GTF.Pr,BGS_GTF.lambda,BGS_GTF.mu,BGS_GTF.rho,BGS_GTF.nu,BGS_GTF.turank,BGS_GTF.addatoms,BGS_GTF.shape_re,BGS_GTF.IniLoop,BGS_GTF.MaxLoop,BGS_GTF.ConvTol);
...
FuVar.lambda_m=1e-1;  FuVar.lambda_a=1e-2;   FuVar.lambda_1=1e0;  
FuVar.lambda_2=1e0;   Psi_init=ones(L,p);
Time.FuVar=tic;
...
%%  GSFus 
fprintf('============================================================= GSFus ============================================================= \n');
GSFus.subspace=3;      GSFus.lambda_1=1e-2; 
GSFus.lambda_2=1e-2;   GSFus.mu=1e1;       
Time.GSFus=tic;
...
%%  BTD-Var
fprintf('============================================================= BTD-Var ============================================================= \n');
BTD_Var.R=5;        BTD_Var.L=20;       BTD_Var.nIter=100;  
BTD_Var.lamda=1e2;  BTD_Var.r=BTD_Var.L*ones(1,BTD_Var.R);
Time.BTD_Var=tic;
